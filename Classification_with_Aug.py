...
fold_path = f'lr-{learning_rate}_opti-RMSprop_AdapThres_Aug/'
fold = os.listdir('best_models')
if 'lr-1e-05_opti-RMSprop_AdapThres_Aug' not in fold:
...
train_data_generator = datagen.flow(X_train, y_train_encoded, batch_size=batch_size)

# Train the model using model.fit with data augmentation
history = model.fit(
    train_data_generator,
    epochs=1000,
    validation_data=(X_test, y_test_encoded),
    callbacks=[early_stopping, tensorboard_callback, save_model_callback]
)
